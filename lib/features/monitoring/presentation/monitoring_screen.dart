          ...
          return ListView(
            ...
            children: [
              if (current != null) ...[
                ...
                const Text('Histórico Cardíaco (Últimos segundos)', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 18)),
          ...
          children: [
            ...
            Container(
              ...
              decoration: BoxDecoration(
                color: status == 'Alerta' || status == 'Febre' ? Colors.red.withOpacity(0.1) : Colors.green.withOpacity(0.1),
                borderRadius: BorderRadius.circular(20),
              ),
              child: Text(
                status,
                style: TextStyle(
                  color: status == 'Alerta' || status == 'Febre' ? Colors.red : Colors.green,
